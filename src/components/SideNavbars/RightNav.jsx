      ...
      <div>
        ...
        <div>
          ...
          <div className="mt-4 space-y-2 px-5 mb-6">
            ...
            <p className="text-[12px] text-gray-500 text-opacity-60">We are a digital design agency based in vancouvar, Canada with <span className="font-semibold text-black opacity-65">10+ years</span> of experience designing products </p>
          </div>
          ...
          <div className="flex px-5 items-center gap-3">
            <button className="py-[3px] px-[10px] text-white text-[12px] bg-[#2695CF] rounded-2xl">Photos</button>
          ...
          <div className="flex mt-5 px-5 items-center gap-2">
            <div className="w-20 rounded-lg h-16 bg-[#F9B2F8]"></div>
            <div className="w-14 rounded-lg h-16 bg-[#F9D0DE]"></div>
            <div className="w-8 rounded-lg h-16 bg-gradient-to-l from-[#3A85EE] to-[#F04488]"></div>
          </div>

          <div className="px-5 mt-6 flex items-center justify-between">
            <div className="flex gap-4">
            <FaUser className="text-gray-400" />
            <p className="text-[12px] text-gray-400 font-semibold">Members <span className="text-[#2695CF]">(22)</span></p>
            </div>
            <div>
